...
const runTimeBrowser = env.RUNTIME_BROWSER as string;
const maxBrowserInstance = Number(env.MAX_BROWSER_INSTANCE) || 2;
const runtimeRetries = 2;
let runTimeService = "chromedriver";
let runTimeCapabilities = {};
console.log(`BROWSER: ${runTimeBrowser}`);

switch (runTimeBrowser) {
  case "chrome":
    runTimeCapabilities = [
      {
...
export const config: Options.Testrunner = {
  ...
  logLevel: (env.LOG_LEVEL || "error") as WebDriverLogTypes,
  //
  ...
  //   logger.info(`Launching URL: [${env.BASE_URL}]`);
  // },
  /**
